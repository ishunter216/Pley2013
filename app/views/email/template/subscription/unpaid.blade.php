    ...
    <tr>
        <td style="padding-left: 20px; padding-right: 20px;">
            <p style="color: #515151; font-family: arial,helvetica,sans-serif; font-size: 17px; line-height: 20px;">
                We failed to charge your credit card, so unfortunately you will not receive your Pley box this month.
            </p>
            <p style="color: #515151; font-family: arial,helvetica,sans-serif; font-size: 17px; line-height: 20px;">
                We'll make another charge attempt when the next box shipping starts.
            </p>
        </td>
    </tr>
    <tr>
