 ...
 * to redeem a coupon which redemptions sum has exceeded the maxUsages limit set.
 *
 ...
 */
class CouponMaxUsagesExceededException extends \RuntimeException implements ExceptionInterface
{
    ...
    )
    {
        ...
        parent::__construct($message, ExceptionCode::COUPON_MAX_USAGES_EXCEEDED, $previous);
    }
