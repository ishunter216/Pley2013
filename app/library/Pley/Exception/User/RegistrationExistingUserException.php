...
/**
 * The <kbd>RegistrationExistingUserException</kbd>
 *
 * @author Alejandro Salazar (alejandros@pley.com)
 * @version 1.0
 */
class RegistrationExistingUserException extends \RuntimeException implements ExceptionInterface
{
    public function __construct(\Pley\Entity\User\User $user, \Exception $previous = null)
    {
        $message = json_encode(['userId' => $user->getId()]);
        parent::__construct($message, ExceptionCode::REGISTRATION_EXISTING_USER, $previous);
    }
